<div class="grid grid-cols-1 md:grid-cols-5 gap-8">
    ...
    {{-- Blog --}}
    <div>
        <h4 class="text-sm font-semibold text-foreground mb-3">Berita & Artikel</h4>
        <ul class="space-y-2 text-sm text-muted-foreground">
            <li><a href="{{ $blogUrl }}/categories" class="hover:text-foreground transition-colors">Semua Kategori</a></li>
            <li><a href="{{ $blogUrl }}/tags" class="hover:text-foreground transition-colors">Topik & Tag</a></li>
            <li><a href="{{ $blogUrl }}/authors" class="hover:text-foreground transition-colors">Penulis Artikel</a></li>
            <li><a href="{{ $blogUrl }}/rss.xml" class="hover:text-foreground transition-colors">RSS Feed</a></li>
        </ul>
    </div>
</div>
